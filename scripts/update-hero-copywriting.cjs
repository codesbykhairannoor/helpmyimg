...
const heroCopy = {
  en: {
    "hero.badge": "",
    "hero.title": "Professional Photo Studio & Bulk Toolkit",
    ...
    "landing.default.title.home": "Professional Photo Studio & Bulk Toolkit",
  ...
  id: {
    ...
    "landing.default.title.home": "Studio Foto & Pengeditan Massal Profesional",
  ...
  ja: {
    ...
    "landing.default.title.home": "プロ仕様のオールインワン写真スタジオ",
  ...
  es: {
    "hero.badge": "",
    "hero.title": "Estudio Fotográfico Profesional Todo en Uno",
    ...
    "landing.default.title.home": "Estudio Fotográfico Profesional Todo en Uno",
  ...
  zh: {
    ...
    "landing.default.title.home": "专业级一站式批量图像处理与摄影工作室",
  ...
  hi: {
    ...
    "landing.default.title.home": "पेशेवर ऑल-इन-वन फ़ोटो स्टूडियो और बल्क एडिटर",
  ...
  ar: {
    ...
    "landing.default.title.home": "الاستوديو الاحترافي الشامل لتحرير الصور والمعالجة الجماعية",
  ...
  fr: {
    "hero.badge": "",
    "hero.title": "Studio Photo Professionnel & Boîte à Outils",
    ...
    "landing.default.title.home": "Studio Photo Professionnel & Boîte à Outils",
  ...
  de: {
    "hero.badge": "",
    "hero.title": "Professionelles All-in-One Fotostudio & Toolkit",
    ...
    "landing.default.title.home": "Professionelles All-in-One Fotostudio & Toolkit",
  ...
  pt: {
    ...
    "landing.default.title.home": "Estúdio Fotográfico Profissional Tudo-em-Um",
  ...
  ru: {
    ...
    "landing.default.title.home": "Профессиональная фотостудия «Все в одном»",
  ...
  ko: {
    ...
    "landing.default.title.home": "전문가용 올인원 포토 스튜디오 & 대량 편집기",
...
for (const langDir of dirs) {
  ...
  if (fs.existsSync(filePath)) {
    try {
      ...
      // Also ensure any leftover "Help Your Image Shine:" / "Help Your Image Shine：" in hero keys is stripped
      if (data['hero.title'] && data['hero.title'].includes('Help Your Image Shine')) {
        data['hero.title'] = data['hero.title'].replace(/^Help Your Image Shine[:：\s-]+/i, '').trim();
        modified = true;
      }
      if (data['landing.default.title.home'] && data['landing.default.title.home'].includes('Help Your Image Shine')) {
        data['landing.default.title.home'] = data['landing.default.title.home'].replace(/^Help Your Image Shine[:：\s-]+/i, '').trim();
        modified = true;
      }
      ...
      if (modified) {
        ...
        count++;
        console.log(`✓ Updated hero copywriting for [${langDir}] (Removed Help Your Image Shine)`);
      }
    } catch (e) {
...
console.log(`\n🎉 Successfully removed "Help Your Image Shine" prefix across ${count} language files!`);
