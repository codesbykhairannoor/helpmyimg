// scripts/test-adaptive.mjs
import sharp from 'sharp';

export async function detectImageType(imageBuffer) {
  ...
  const isLowPalette = uniqueColorCount < 150 || top3Share > 0.80;
...
async function main() {
  const logoRes = await detectImageType('public/images.png');
  console.log('public/images.png ->', logoRes);
}
