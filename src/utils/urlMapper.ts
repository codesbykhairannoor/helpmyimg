...
export const SLUG_MAP: Record<string, Record<string, string>> = {
  ar: { remove: 'izalat-khalfia', color: 'taghyir-khalfia', watermark: 'alama-maiya', compress: 'daght-sura', compress100kb: 'daght-sura-100kb', convert: 'tahwil-sura', resize: 'taghyir-hajm', crop: 'qass-sura', rotate: 'tadwir-sura', picker: 'istikhraja-alwan', blurface: 'tamwih-al-wajh', design: 'muharrir-tasamim', brush: 'furshat-sihriya', compress50kb: 'daght-sura-50kb', resizeig: 'taghyir-hajm-instagram', removelogo: 'remove-background-from-logo', colorwhite: 'change-photo-background-to-white', compress200kb: '200', resizepassport: 'resize-photo-to-passport-size' },
  ...
  es: { remove: 'quitar-fondo', color: 'cambiar-fondo', watermark: 'marca-de-agua', compress: 'comprimir-imagen', compress100kb: 'comprimir-imagen-a-100kb', convert: 'convertir-imagen', resize: 'redimensionar-imagen', crop: 'recortar-imagen', rotate: 'rotar-imagen', picker: 'selector-de-color', blurface: 'difuminar-rostro', design: 'editor-de-diseno', brush: 'pincel-magico', compress50kb: 'comprimir-imagen-a-50kb', resizeig: 'redimensionar-para-instagram', removelogo: 'eliminar-el-fondo-del-logo', colorwhite: 'cambiar-el-fondo-de-la-foto-a-blanco', compress200kb: 'comprimir-imagen-a-200kb', resizepassport: 'cambiar-el-tamao-de-la-foto-al-tamao-pasaporte' },
  fi: { remove: 'poista-tausta', color: 'vaihda-tausta', watermark: 'vesileima', compress: 'pakkaa-kuva', compress100kb: 'pakkaa-100kb', convert: 'muunna-kuva', resize: 'muuta-kokoa', crop: 'rajaa-kuva', rotate: 'kierita-kuva', picker: 'varipaletti', blurface: 'sumentaa-kasvot', design: 'kehittynyt-editori', brush: 'taikasivellin', compress50kb: 'pakkaa-50kb', resizeig: 'muuta-kokoa-instagram', removelogo: 'poista-tausta-logosta', colorwhite: 'muuta-valokuvan-tausta-valkoiseksi', compress200kb: 'pakkaa-kuvan-kokoon-200-kb', resizepassport: 'muuta-valokuvan-kokoa-passin-kokoon' },
  fr: { remove: 'supprimer-fond', color: 'changer-fond', watermark: 'filigrane', compress: 'compresser-image', compress100kb: 'compresser-image-100ko', convert: 'convertir-image', resize: 'redimensionner-image', crop: 'rogner-image', rotate: 'pivoter-image', picker: 'pipette-couleur', blurface: 'flouter-visage', design: 'editeur-avance', brush: 'pinceau-magique', compress50kb: 'compresser-image-50ko', resizeig: 'redimensionner-pour-instagram', removelogo: 'supprimer-larrireplan-du-logo', colorwhite: 'changer-le-fond-de-la-photo-en-blanc', compress200kb: 'compresser-limage-200-ko', resizepassport: 'redimensionner-la-photo-au-format-passeport' },
  he: { remove: 'hasarat-reka', color: 'shinui-reka', watermark: 'siman-maim', compress: 'dchisat-tmuna', compress100kb: 'dchisat-tmuna-100kb', convert: 'hamarat-tmuna', resize: 'shinui-godel', crop: 'chitucha-tmuna', rotate: 'sivuv-tmuna', picker: 'bocher-tseva', blurface: 'tistush-panim', design: 'orech-itzuv', brush: 'mivreshet-kesem', compress50kb: 'dchisat-tmuna-50kb', resizeig: 'shinui-godel-instagram', removelogo: 'remove-background-from-logo', colorwhite: 'change-photo-background-to-white', compress200kb: '200kb', resizepassport: 'resize-photo-to-passport-size' },
  hi: { remove: 'background-hatao', color: 'background-badlo', watermark: 'watermark-lagao', compress: 'image-compress', compress100kb: 'image-compress-100kb', convert: 'image-convert', resize: 'image-resize', crop: 'image-crop', rotate: 'image-rotate', picker: 'rang-chunen', blurface: 'chehra-dhundhla-kare', design: 'design-editor', brush: 'magic-brush', compress50kb: 'image-compress-50kb', resizeig: 'instagram-image-resize', removelogo: 'remove-background-from-logo', colorwhite: 'change-photo-background-to-white', compress200kb: '200kb', resizepassport: 'resize-photo-to-passport-size' },
  hu: { remove: 'hatter-eltavolitas', color: 'hatter-modositas', watermark: 'vizjel', compress: 'kep-tomorites', compress100kb: 'kep-tomorites-100kb', convert: 'kep-konvertalas', resize: 'kep-atmeretezes', crop: 'kep-vagas', rotate: 'kep-forgatas', picker: 'szinvalaszto', blurface: 'arc-elmosasa', design: 'fejlett-szerkeszto', brush: 'varazsecset', compress50kb: 'kep-tomorites-50kb', resizeig: 'instagram-atmeretezes', removelogo: 'tvoltsa-el-a-htteret-a-logrl', colorwhite: 'mdostsa-a-fnykp-httert-fehrre', compress200kb: 'tmrtse-a-kpet-200-kbra', resizepassport: 'a-fnykp-tmretezse-az-tlevl-mretre' },
  id: { remove: 'hapus-latar-belakang', color: 'ganti-background', watermark: 'buat-watermark', compress: 'kompres-gambar', compress100kb: 'kompres-foto-100kb', convert: 'ubah-format-gambar', resize: 'ubah-ukuran-gambar', crop: 'potong-gambar', rotate: 'putar-gambar', picker: 'ambil-warna-gambar', blurface: 'sensor-wajah', design: 'editor-desain', brush: 'kuas-ajaib', compress50kb: 'kompres-foto-50kb', resizeig: 'ubah-ukuran-instagram', removelogo: 'hapus-latar-belakang-dari-logo', colorwhite: 'ubah-background-foto-menjadi-putih', compress200kb: 'kompres-gambar-menjadi-200kb', resizepassport: 'mengubah-ukuran-foto-menjadi-ukuran-paspor' },
  it: { remove: 'rimuovi-sfondo', color: 'cambia-sfondo', watermark: 'filigrana', compress: 'comprimi-immagine', compress100kb: 'comprimi-immagine-100kb', convert: 'converti-immagine', resize: 'ridimensiona-immagine', crop: 'ritaglia-immagine', rotate: 'ruota-immagine', picker: 'selettore-colore', blurface: 'sfoca-viso', design: 'editor-di-design', brush: 'pennello-magico', compress50kb: 'comprimi-immagine-50kb', resizeig: 'ridimensiona-per-instagram', removelogo: 'rimuovere-lo-sfondo-dal-logo', colorwhite: 'cambia-lo-sfondo-della-foto-in-bianco', compress200kb: 'comprimere-limmagine-a-200kb', resizepassport: 'ridimensionare-la-foto-in-formato-tessera' },
  ja: { remove: 'haikei-sakuzyo', color: 'haikei-henko', watermark: 'sukashi', compress: 'gazo-asshuku', compress100kb: 'gazo-asshuku-100kb', convert: 'gazo-henkan', resize: 'gazo-ri-saizu', crop: 'gazo-torimingu', rotate: 'gazo-kaiten', picker: 'iro-supotto', blurface: 'kao-bokashi', design: 'dezain-edita', brush: 'majikku-burashi', compress50kb: 'gazo-asshuku-50kb', resizeig: 'insutaguramu-ri-saizu', removelogo: 'remove-background-from-logo', colorwhite: 'change-photo-background-to-white', compress200kb: '200kb', resizepassport: 'resize-photo-to-passport-size' },
  ko: { remove: 'baegyeong-jegeo', color: 'baegyeong-byeongyeong', watermark: 'woteomakeu', compress: 'imiji-abchuk', compress100kb: 'imiji-abchuk-100kb', convert: 'imiji-byeonhwan', resize: 'imiji-keugi-jojeong', crop: 'imiji-jareugi', rotate: 'imiji-hoejeon', picker: 'saek-chuchul', blurface: 'eolgul-beulleo', design: 'dijain-editeo', brush: 'maejik-beureosi', compress50kb: 'imiji-abchuk-50kb', resizeig: 'inseuta-imiji-keugi', removelogo: 'remove-background-from-logo', colorwhite: 'change-photo-background-to-white', compress200kb: '200kb', resizepassport: 'resize-photo-to-passport-size' },
  ms: { remove: 'buang-latar-belakang', color: 'tukar-latar-belakang', watermark: 'tanda-air', compress: 'mampat-imej', compress100kb: 'mampat-imej-100kb', convert: 'tukar-imej', resize: 'ubah-saiz-imej', crop: 'pangkas-imej', rotate: 'putar-imej', picker: 'pemilih-warna', blurface: 'kabur-wajah', design: 'editor-reka-bentuk', brush: 'berus-ajaib', compress50kb: 'mampat-imej-50kb', resizeig: 'ubah-saiz-instagram', removelogo: 'alih-keluar-latar-belakang-daripada-logo', colorwhite: 'menukar-latar-belakang-foto-kepada-putih', compress200kb: 'mampatkan-imej-kepada-200kb', resizepassport: 'ubah-saiz-gambar-kepada-saiz-pasport' },
  nl: { remove: 'achtergrond-verwijderen', color: 'achtergrond-wijzigen', watermark: 'watermerk', compress: 'afbeelding-comprimeren', compress100kb: 'afbeelding-comprimeren-100kb', convert: 'afbeelding-converteren', resize: 'afbeelding-verkleinen', crop: 'afbeelding-bijsnijden', rotate: 'afbeelding-draaien', picker: 'kleurkiezer', blurface: 'gezicht-vervagen', design: 'geavanceerde-editor', brush: 'magisch-penseel', compress50kb: 'afbeelding-comprimeren-50kb', resizeig: 'verkleinen-voor-instagram', removelogo: 'achtergrond-uit-logo-verwijderen', colorwhite: 'verander-de-fotoachtergrond-naar-wit', compress200kb: 'comprimeer-de-afbeelding-tot-200-kb', resizepassport: 'formaat-van-foto-wijzigen-naar-paspoortformaat' },
  no: { remove: 'fjern-bakgrunn', color: 'endre-bakgrunn', watermark: 'vannmerke', compress: 'komprimer-bilde', compress100kb: 'komprimer-til-100kb', convert: 'konverter-bilde', resize: 'endre-bildestorrelse', crop: 'beskjaer-bilde', rotate: 'roter-bilde', picker: 'fargevelger', blurface: 'sladd-ansikt', design: 'avansert-editor', brush: 'magisk-pensel', compress50kb: 'komprimer-til-50kb', resizeig: 'endre-storrelse-instagram', removelogo: 'fjern-bakgrunn-fra-logoen', colorwhite: 'endre-bildebakgrunnen-til-hvit', compress200kb: 'komprimere-bildet-til-200kb', resizepassport: 'endre-strrelsen-p-bildet-til-passstrrelsen' },
  pl: { remove: 'usun-tlo', color: 'zmien-tlo', watermark: 'znak-wodny', compress: 'kompresja-obrazu', compress100kb: 'kompresja-obrazu-100kb', convert: 'konwersja-obrazu', resize: 'zmiana-rozmiaru', crop: 'przycinanie-obrazu', rotate: 'obroc-obraz', picker: 'wybieracz-kolorow', blurface: 'rozmycie-twarzy', design: 'zaawansowany-edytor', brush: 'magiczny-pedzel', compress50kb: 'kompresja-obrazu-50kb', resizeig: 'zmiana-rozmiaru-instagram', removelogo: 'usu-to-z-logo', colorwhite: 'zmie-to-zdjcia-na-biae', compress200kb: 'skompresuj-obraz-do-200kb', resizepassport: 'zmie-rozmiar-zdjcia-na-rozmiar-paszportowy' },
  pt: { remove: 'remover-fundo', color: 'mudar-fundo', watermark: 'marca-dagua', compress: 'comprimir-imagem', compress100kb: 'comprimir-imagem-100kb', convert: 'converter-imagem', resize: 'redimensionar-imagem', crop: 'cortar-imagem', rotate: 'girar-imagem', picker: 'seletor-de-cores', blurface: 'desfocar-rosto', design: 'editor-de-design', brush: 'pincel-magico', compress50kb: 'comprimir-imagem-50kb', resizeig: 'redimensionar-para-instagram', removelogo: 'remover-fundo-do-logotipo', colorwhite: 'mudar-o-fundo-da-foto-para-branco', compress200kb: 'comprimir-imagem-para-200kb', resizepassport: 'redimensionar-foto-para-tamanho-de-passaporte' },
  ro: { remove: 'eliminare-fundal', color: 'schimbare-fundal', watermark: 'filigran', compress: 'comprimare-imagine', compress100kb: 'comprimare-imagine-100kb', convert: 'convertire-imagine', resize: 'redimensionare-imagine', crop: 'decupare-imagine', rotate: 'rotire-imagine', picker: 'selector-culori', blurface: 'estompare-fata', design: 'editor-avansat', brush: 'pensula-magica', compress50kb: 'comprimare-imagine-50kb', resizeig: 'redimensionare-instagram', removelogo: 'eliminai-fundalul-din-logo', colorwhite: 'schimba-fundalul-fotografiei-n-alb', compress200kb: 'comprimai-imaginea-la-200-kb', resizepassport: 'redimensionai-fotografia-la-dimensiunea-paaportului' },
  ru: { remove: 'udalit-fon', color: 'izmenit-fon', watermark: 'vodyanoy-znak', compress: 'szhat-izobrazhenie', compress100kb: 'szhat-izobrazhenie-100kb', convert: 'konvertirovat-izobrazhenie', resize: 'izmenit-razmer', crop: 'obrezat-izobrazhenie', rotate: 'povernut-izobrazhenie', picker: 'vybor-tsveta', blurface: 'razmyt-litso', design: 'rasshirennyy-redaktor', brush: 'volshebnaya-kist', compress50kb: 'szhat-izobrazhenie-50kb', resizeig: 'izmenit-razmer-dlya-instagram', removelogo: 'remove-background-from-logo', colorwhite: 'change-photo-background-to-white', compress200kb: '200', resizepassport: 'resize-photo-to-passport-size' },
  sv: { remove: 'ta-bort-bakgrund', color: 'andra-bakgrund', watermark: 'vattenstampel', compress: 'komprimera-bild', compress100kb: 'komprimera-bild-100kb', convert: 'konvertera-bild', resize: 'andra-storlek', crop: 'beskara-bild', rotate: 'rotera-bild', picker: 'fargvaljare', blurface: 'oskarpt-ansikte', design: 'avancerad-redigerare', brush: 'magisk-pensel', compress50kb: 'komprimera-bild-50kb', resizeig: 'andra-storlek-for-instagram', removelogo: 'ta-bort-bakgrund-frn-logotypen', colorwhite: 'ndra-fotobakgrunden-till-vit', compress200kb: 'komprimera-bilden-till-200kb', resizepassport: 'ndra-storlek-p-foto-till-passstorlek' },
  th: { remove: 'lop-phun-lang', color: 'plian-phun-lang', watermark: 'lai-nam', compress: 'bip-ad-rup-phap', compress100kb: 'bip-ad-rup-phap-100kb', convert: 'plaeng-rup-phap', resize: 'plian-kha-nad-rup', crop: 'tat-rup-phap', rotate: 'mun-rup-phap', picker: 'luk-si', blurface: 'blae-na', design: 'khrueang-mue-ook-baeb', brush: 'paeng-wises', compress50kb: 'bip-ad-rup-phap-50kb', resizeig: 'plian-kha-nad-ig', removelogo: 'remove-background-from-logo', colorwhite: 'change-photo-background-to-white', compress200kb: '200kb', resizepassport: 'resize-photo-to-passport-size' },
