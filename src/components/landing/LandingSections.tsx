    ...
    <div className="space-y-24 py-16 text-slate-100">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8">
          <div className="glass-panel p-6 sm:p-8 rounded-3xl border-dark-500/60 flex flex-col sm:flex-row gap-4 sm:gap-6 items-start hover:border-[#05DAED]/30 transition-colors">
            <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-[#05DAED]/10 border border-[#05DAED]/30 flex items-center justify-center shrink-0 text-[#05DAED]">
            ...
            <div className="space-y-3">
              ...
              <ul className="text-xs text-slate-400 space-y-1 pt-1 font-medium">
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-3.5 h-3.5 text-[#05DAED] shrink-0 mt-0.5" />
          ...
          <div className="glass-panel p-6 sm:p-8 rounded-3xl border-dark-500/60 flex flex-col sm:flex-row gap-4 sm:gap-6 items-start hover:border-[#12DA91]/30 transition-colors">
            <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-[#12DA91]/10 border border-[#12DA91]/30 flex items-center justify-center shrink-0 text-[#12DA91]">
            ...
            <div className="space-y-3">
              ...
              <ul className="text-xs text-slate-400 space-y-1 pt-1 font-medium">
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-3.5 h-3.5 text-[#12DA91] shrink-0 mt-0.5" />
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="glass-panel p-6 sm:p-14 rounded-3xl border-dark-500/60 relative overflow-hidden bg-gradient-to-b from-dark-900/90 to-dark-800/90">
          <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-16 px-4 relative z-10">
            <span className="text-xs font-mono font-bold uppercase tracking-widest text-[#05DAED] bg-[#05DAED]/10 px-3 py-1.5 rounded-full border border-[#05DAED]/30 block w-max mx-auto mb-4">
              {tp('work.tag')}
            </span>
            <h2 className="text-2xl sm:text-4xl lg:text-5xl font-heading font-extrabold text-white leading-tight">
