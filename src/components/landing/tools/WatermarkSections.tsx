...
import { ShieldAlert, Layers, SlidersHorizontal, Grid, Fingerprint, Lock, Upload, Save, Sparkles } from 'lucide-react';
    ...
    <div className="space-y-32 py-16 text-slate-100 overflow-hidden">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-dark-800/40 p-8 rounded-3xl border border-[#8B5CF6]/20 hover:border-[#8B5CF6]/50 transition-colors group">
            <div className="w-12 h-12 bg-[#8B5CF6]/10 text-[#8B5CF6] rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
          ...
          <div className="bg-dark-800/40 p-8 rounded-3xl border border-[#F43F5E]/20 hover:border-[#F43F5E]/50 transition-colors group">
            <div className="w-12 h-12 bg-[#F43F5E]/10 text-[#F43F5E] rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
