...
import { Palette, Wand2, Image as ImageIcon, Zap, Focus, Monitor, LayoutGrid, Droplet, Download, Lock, Sparkles } from 'lucide-react';
    ...
    <div className="space-y-32 py-16 text-slate-100 overflow-hidden">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-24">
        <div className="text-center max-w-3xl mx-auto mb-16 px-4">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl sm:font-heading font-extrabold leading-tight">
