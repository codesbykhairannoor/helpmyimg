      ...
      <section className="max-w-7xl mx-auto w-full relative" style={{ padding: '80px 24px', marginBottom: '80px' }}>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          <div className="flex-1 space-y-8 z-10 text-center lg:text-left">
            ...
            <h2 className="font-heading font-extrabold text-white mt-4 sm:mt-6 tracking-tight bg-clip-text bg-gradient-to-r from-white via-slate-200 to-slate-400" style={{ fontSize: 'clamp(1.35rem, 4vw, 2.5rem)', fontWeight: 800, lineHeight: 1.2 }}>
