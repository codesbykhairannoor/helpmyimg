...
export const SplitHowToSection: React.FC<SectionProps> = ({ section }) => (
  <section className="seo-section split-how-to" style={{ padding: '60px 24px', margin: '40px 0' }}>
    <h2 style={{ fontSize: 'clamp(1.5rem, 4vw, 2.5rem)', fontWeight: 800, textAlign: 'left', marginBottom: 40, color: 'var(--text-main)', paddingBottom: 16, borderBottom: '2px solid var(--border-color)' }}>{section.title}</h2>
