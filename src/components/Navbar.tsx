              ...
              <div className="grid grid-cols-3 gap-2">
                {[
                  ...
                  <button 
                    ...
                    className="bg-dark-800 hover:bg-dark-700 border border-dark-600/50 py-2 px-1.5 rounded-lg font-bold text-slate-200 text-[0.78rem] uppercase tracking-widest text-center shadow-sm transition-colors leading-tight flex items-center justify-center min-h-[36px]"
                  >
