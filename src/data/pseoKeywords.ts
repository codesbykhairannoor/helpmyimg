...
export const PSEO_KEYWORD_MATRIX: PSeoKeywordConfig[] = [
  // --- INDONESIA (ID) - FOKUS BIROKRASI CPNS/KTP & E-COMMERCE ---
  {
    ...
    tool: 'color',
    lang: 'id',
    title: 'Ganti Background Foto Merah CPNS 2026 Gratis Tanpa Studio - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'color',
    lang: 'id',
    title: 'Ganti Background Biru KTP & Ijazah Online Gratis Tanpa Aplikasi - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'remove',
    lang: 'id',
    title: 'Hapus Background Foto Produk E-Commerce Shopee & Tokopedia - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'remove',
    lang: 'id',
    title: 'Blur Background Foto Profil LinkedIn Ala DSLR Bokeh Studio - HelpMyIMG',
  ...
  // --- ENGLISH (EN) - GLOBAL E-COMMERCE, API & PROFESSIONAL FOCUS ---
  {
    ...
    tool: 'remove',
    lang: 'en',
    title: 'Free Transparent Background Remover for E-Commerce & Shopify - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'remove',
    lang: 'en',
    title: 'DSLR Bokeh Portrait Background Blur Maker Online - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'color',
    lang: 'en',
    title: 'Biometric Passport Photo Background Color Changer Online - HelpMyIMG',
  ...
  // --- SPANISH (ES) - MERCADO LATAM & ESPAÑA ---
  {
    ...
    tool: 'remove',
    lang: 'es',
    title: 'Quitar Fondo de Imagen Gratis para E-Commerce y Mercado Libre - HelpMyIMG',
  ...
  // --- HINDI (HI) - INDIA MASSIVE TRAFFIC PORTAL ---
  {
    ...
    tool: 'remove',
    lang: 'hi',
    title: 'फ्री फोटो बैकग्राउंड रिमूवर ऑनलाइन (100% Free & Offline) - HelpMyIMG',
  ...
  // --- ARABIC (AR) - MIDDLE EAST RTL FOCUS ---
  {
    ...
    tool: 'remove',
    lang: 'ar',
    title: 'إزالة خلفية الصورة مجاناً وبدون إنترنت (AI WebGPU) - HelpMyIMG',
  ...
  // --- CHINESE (ZH) - E-COMMERCE & TAOBAO/TIKTOK FOCUS ---
  {
    ...
    tool: 'remove',
    lang: 'zh',
    title: '免费AI一键抠图与背景移除工具 (电商品牌专用) - HelpMyIMG',
  ...
  // --- PORTUGUESE (PT) - BRAZIL & LATAM FOCUS ---
  {
    ...
    tool: 'remove',
    lang: 'pt',
    title: 'Remover Fundo de Foto Grátis e Online (Sem Upload no Servidor) - HelpMyIMG',
  ...
  // --- JAPANESE (JA) - CREATIVE & BIOMETRIC FOCUS ---
  {
    ...
    tool: 'remove',
    lang: 'ja',
    title: '無料AI背景透過・画像切り抜きツール (完全プライバシー保護) - HelpMyIMG',
  ...
  // --- FRENCH (FR) - EUROPE & E-COMMERCE ---
  {
    ...
    tool: 'remove',
    lang: 'fr',
    title: 'Enlever le Fond dune Image Gratuitement en Ligne (IA 100% Privée) - HelpMyIMG',
  ...
  // --- GERMAN (DE) - DACH REGION & GDPR PRIVACY FOCUS ---
  {
    ...
    tool: 'remove',
    lang: 'de',
    title: 'Hintergrund Entfernen Kostenlos (100% DSGVO-Konform & Offline) - HelpMyIMG',
  ...
  // --- KOREAN (KO) - FOKUS COUPANG, NAVER & RIREKISHO ---
  {
    ...
    tool: 'remove',
    lang: 'ko',
    title: '쿠팡 및 네이버 스마트스토어 상품 사진 누끼따기 무료 AI - HelpMyIMG',
  ...
  // --- VIETNAMESE (VI) - FOKUS SHOPEE & LAZADA VN ---
  {
    ...
    tool: 'remove',
    lang: 'vi',
    title: 'Xóa Nền Ảnh Sản Phẩm Shopee & Lazada Miễn Phí AI - HelpMyIMG',
  ...
  // --- THAI (TH) - FOKUS SHOPEE & LAZADA TH ---
  {
    ...
    tool: 'remove',
    lang: 'th',
    title: 'ลบพื้นหลังรูปสินค้า Shopee & Lazada ฟรีด้วย AI - HelpMyIMG',
  ...
  // --- MALAY (MS) - FOKUS SHOPEE / LAZADA MY & PASPORT ---
  {
    ...
    tool: 'remove',
    lang: 'ms',
    title: 'Buang Latar Belakang Gambar Produk Shopee & Lazada - HelpMyIMG',
  ...
  // --- TAGALOG (TL) - FOKUS SHOPEE / LAZADA PH ---
  {
    ...
    tool: 'remove',
    lang: 'tl',
    title: 'Alisin ang Background ng Larawan para sa Shopee & Lazada - HelpMyIMG',
  ...
  // --- GREEK (EL) ---
  {
    ...
    tool: 'remove',
    lang: 'el',
    title: 'Αφαίρεση Φόντου από Φωτογραφίες για Skroutz & E-shop - HelpMyIMG',
  ...
  // NEW MASSIVE OVERHAUL KEYWORDS FOR COMPRESS, CONVERT, RESIZE
  {
    ...
    tool: 'compress',
    lang: 'id',
    title: 'Kompres Foto Jadi 200KB Gratis (CPNS/Lamaran Kerja) - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'convert',
    lang: 'id',
    title: 'Ubah PNG Transparan Jadi JPG Putih (Otomatis) - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'resize',
    lang: 'id',
    title: 'Ubah Ukuran (Resize) Foto Jadi 4x6 untuk CPNS & KTP - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'compress',
    lang: 'en',
    title: 'Compress JPEG to 200KB Free (Passport & Visa) - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'convert',
    lang: 'en',
    title: 'Convert WEBP to JPG Free on Mac/Windows - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'resize',
    lang: 'es',
    title: 'Redimensionar Imagen para Pasaporte (4x6) Gratis - HelpMyIMG',
...
,
  {
    ...
    tool: 'compress',
    lang: 'ar',
    title: 'ضغط صورة to 200KB مجاني - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'convert',
    lang: 'ar',
    title: 'تحويل WEBP to JPG مجاني - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'resize',
    lang: 'ar',
    title: 'تغيير الحجم صورة to 4x6 مجاني - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'compress',
    lang: 'bg',
    title: 'Компресиране Изображение to 200KB Безплатно - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'convert',
    lang: 'bg',
    title: 'Конвертиране WEBP to JPG Безплатно - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'resize',
    lang: 'bg',
    title: 'Преоразмеряване Изображение to 4x6 Безплатно - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'compress',
    lang: 'cs',
    title: 'Komprimovat Obrázek to 200KB Zdarma - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'convert',
    lang: 'cs',
    title: 'Převést WEBP to JPG Zdarma - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'resize',
    lang: 'cs',
    title: 'Změnit velikost Obrázek to 4x6 Zdarma - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'compress',
    lang: 'da',
    title: 'Komprimer Billede to 200KB Gratis - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'convert',
    lang: 'da',
    title: 'Konverter WEBP to JPG Gratis - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'resize',
    lang: 'da',
    title: 'Tilpas Billede to 4x6 Gratis - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'compress',
    lang: 'de',
    title: 'Komprimieren Bild to 200KB Kostenlos - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'convert',
    lang: 'de',
    title: 'Konvertieren WEBP to JPG Kostenlos - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'resize',
    lang: 'de',
    title: 'Größe ändern Bild to 4x6 Kostenlos - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'compress',
    lang: 'el',
    title: 'Συμπίεση Εικόνα to 200KB Δωρεάν - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'convert',
    lang: 'el',
    title: 'Μετατροπή WEBP to JPG Δωρεάν - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'resize',
    lang: 'el',
    title: 'Αλλαγή μεγέθους Εικόνα to 4x6 Δωρεάν - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'compress',
    lang: 'fi',
    title: 'Pakkaa Kuva to 200KB Ilmainen - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'convert',
    lang: 'fi',
    title: 'Muunna WEBP to JPG Ilmainen - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'resize',
    lang: 'fi',
    title: 'Muuta kokoa Kuva to 4x6 Ilmainen - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'compress',
    lang: 'fr',
    title: 'Compresser Image to 200KB Gratuit - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'convert',
    lang: 'fr',
    title: 'Convertir WEBP to JPG Gratuit - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'resize',
    lang: 'fr',
    title: 'Redimensionner Image to 4x6 Gratuit - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'compress',
    lang: 'he',
    title: 'דחיסה תמונה to 200KB חינם - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'convert',
    lang: 'he',
    title: 'המרה WEBP to JPG חינם - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'resize',
    lang: 'he',
    title: 'שינוי גודל תמונה to 4x6 חינם - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'compress',
    lang: 'hi',
    title: 'कंप्रेस छवि to 200KB मुफ़्त - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'convert',
    lang: 'hi',
    title: 'बदलें WEBP to JPG मुफ़्त - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'resize',
    lang: 'hi',
    title: 'आकार बदलें छवि to 4x6 मुफ़्त - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'compress',
    lang: 'hu',
    title: 'Tömörítés Kép to 200KB Ingyenes - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'convert',
    lang: 'hu',
    title: 'Konvertálás WEBP to JPG Ingyenes - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'resize',
    lang: 'hu',
    title: 'Átméretezés Kép to 4x6 Ingyenes - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'compress',
    lang: 'it',
    title: 'Comprimi Immagine to 200KB Gratis - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'convert',
    lang: 'it',
    title: 'Converti WEBP to JPG Gratis - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'resize',
    lang: 'it',
    title: 'Ridimensiona Immagine to 4x6 Gratis - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'compress',
    lang: 'ja',
    title: '圧縮 画像 to 200KB 無料 - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'convert',
    lang: 'ja',
    title: '変換 WEBP to JPG 無料 - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'resize',
    lang: 'ja',
    title: 'サイズ変更 画像 to 4x6 無料 - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'compress',
    lang: 'ko',
    title: '압축 이미지 to 200KB 무료 - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'convert',
    lang: 'ko',
    title: '변환 WEBP to JPG 무료 - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'resize',
    lang: 'ko',
    title: '크기 조정 이미지 to 4x6 무료 - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'compress',
    lang: 'ms',
    title: 'Mampat Imej to 200KB Percuma - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'convert',
    lang: 'ms',
    title: 'Tukar Format WEBP to JPG Percuma - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'resize',
    lang: 'ms',
    title: 'Ubah Saiz Imej to 4x6 Percuma - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'compress',
    lang: 'nl',
    title: 'Comprimeren Afbeelding to 200KB Gratis - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'convert',
    lang: 'nl',
    title: 'Converteren WEBP to JPG Gratis - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'resize',
    lang: 'nl',
    title: 'Formaat wijzigen Afbeelding to 4x6 Gratis - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'compress',
    lang: 'no',
    title: 'Komprimer Bilde to 200KB Gratis - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'resize',
    lang: 'no',
    title: 'Endre størrelse Bilde to 4x6 Gratis - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'compress',
    lang: 'pl',
    title: 'Kompresuj Obraz to 200KB Za darmo - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'convert',
    lang: 'pl',
    title: 'Konwertuj WEBP to JPG Za darmo - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'resize',
    lang: 'pl',
    title: 'Zmień rozmiar Obraz to 4x6 Za darmo - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'compress',
    lang: 'pt',
    title: 'Comprimir Imagem to 200KB Grátis - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'convert',
    lang: 'pt',
    title: 'Converter WEBP to JPG Grátis - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'resize',
    lang: 'pt',
    title: 'Redimensionar Imagem to 4x6 Grátis - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'compress',
    lang: 'ro',
    title: 'Comprimare Imagine to 200KB Gratuit - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'convert',
    lang: 'ro',
    title: 'Convertire WEBP to JPG Gratuit - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'resize',
    lang: 'ro',
    title: 'Redimensionare Imagine to 4x6 Gratuit - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'compress',
    lang: 'ru',
    title: 'Сжатие Изображение to 200KB Бесплатно - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'convert',
    lang: 'ru',
    title: 'Конвертировать WEBP to JPG Бесплатно - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'resize',
    lang: 'ru',
    title: 'Изменить размер Изображение to 4x6 Бесплатно - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'compress',
    lang: 'sv',
    title: 'Komprimera Bild to 200KB Gratis - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'convert',
    lang: 'sv',
    title: 'Konvertera WEBP to JPG Gratis - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'resize',
    lang: 'sv',
    title: 'Ändra storlek Bild to 4x6 Gratis - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'compress',
    lang: 'th',
    title: 'บีบอัด รูปภาพ to 200KB ฟรี - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'convert',
    lang: 'th',
    title: 'แปลง WEBP to JPG ฟรี - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'resize',
    lang: 'th',
    title: 'เปลี่ยนขนาด รูปภาพ to 4x6 ฟรี - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'compress',
    lang: 'tl',
    title: 'I-compress Larawan to 200KB Libre - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'convert',
    lang: 'tl',
    title: 'I-convert WEBP to JPG Libre - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'resize',
    lang: 'tl',
    title: 'I-resize Larawan to 4x6 Libre - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'compress',
    lang: 'tr',
    title: 'Sıkıştır Resim to 200KB Ücretsiz - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'convert',
    lang: 'tr',
    title: 'Dönüştür WEBP to JPG Ücretsiz - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'resize',
    lang: 'tr',
    title: 'Boyutlandır Resim to 4x6 Ücretsiz - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'compress',
    lang: 'uk',
    title: 'Стиснути Зображення to 200KB Безкоштовно - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'convert',
    lang: 'uk',
    title: 'Конвертувати WEBP to JPG Безкоштовно - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'resize',
    lang: 'uk',
    title: 'Змінити розмір Зображення to 4x6 Безкоштовно - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'compress',
    lang: 'vi',
    title: 'Nén Hình ảnh to 200KB Miễn phí - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'convert',
    lang: 'vi',
    title: 'Chuyển đổi WEBP to JPG Miễn phí - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'resize',
    lang: 'vi',
    title: 'Đổi kích thước Hình ảnh to 4x6 Miễn phí - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'compress',
    lang: 'zh',
    title: '压缩 图片 to 200KB 免费 - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'convert',
    lang: 'zh',
    title: '转换 WEBP to JPG 免费 - HelpMyIMG',
  ...
  },
  {
    ...
    tool: 'resize',
    lang: 'zh',
    title: '调整大小 图片 to 4x6 免费 - HelpMyIMG',
